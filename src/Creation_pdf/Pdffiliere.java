...
public class Pdffiliere {
    ...
    public static void generate() {
		...
		try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("C:/Users/Rokia/Desktop/Liste des filières.pdf"));
            document.open();
			...
			while (rs.next())
			{
				table.addCell(rs.getString("Nom_filière"));
